...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 card my-4 intro hide-text hidden" onclick="this.classList.toggle('hidden')">
                <div class="card-body">
                    ...
                    <p class="card-text">Here you can find a DJ mix set I made and a bunch of my favorite albums. I
                        ...
                        sound setup. This can be for a symposium or a club night (if you need speakers in Rotterdam
                        send me a mail), either way the tangle of cables and connections is something I know my way
                        around. Free tip: if you are talking to a large audience with a remote mic and it keeps
                        searching. Turn your volume way down and tell the sound guy to turn his way up.</p>
                    <p>Below you will also find recommendations of albums I particularly enjoy along with some
                        ...
                        straight to Tidal and Spotify, but also Muziekweb. This is a truly great resource for music,
                        collected and maintained by a lot of dedicated experts (and my ex-colleagues) in Rotterdam.
                        Their collection has been built up and meticulously maintained since 1963 and there is a big
            ...
            <skills class="col-lg-4" @auth:prod="true" @endauth :skill_name="'music'"
