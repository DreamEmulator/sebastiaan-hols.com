...
<template>
    <div class="card my-4">
        ...
        <div v-if="prod" class="card-body">
            <button class="btn-success" v-on:click="add_skill = !add_skill"
                    v-if="add_skill==false && remove_skills==false">New
                skill
            </button>
            ...
            <button v-if="remove_skills==true" v-on:click="remove_skills = false" class="btn-danger float-right">
                Cancel
            </button>
        </div>
    </div>
